...
class Dataset(data.Dataset):
    ...
    def __getitem__(self, index):
        ...
        conv_GPT2 = torch.LongTensor(self.data_info['conv_GPT2'][index])
        conv_GPT2 = _cuda(conv_GPT2.contiguous())
        input_ids = torch.Tensor(self.data_info['input_ids'][index])
        ...
        # data_info['sketch_response_plain'] = self.data_info['sketch_response_plain'][index]
