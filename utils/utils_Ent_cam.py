...
def prepare_data_seq(tokenizer, batch_size=100, data_augmentation_file=None):
    file_train = './data/fine-tune/CamRest676/train.txt'
    file_test = './data/fine-tune/CamRest676/test.txt'
    if data_augmentation_file is not None:
        file_dev = './data/pre-train/CamRest676/dev.txt'
        pkl_name = './data/pre-train/CamRest676/pretrain_dataset.pkl'
    else:
        file_dev = './data/fine-tune/CamRest676/dev.txt'
        pkl_name = './data/fine-tune/CamRest676/fine_tune_dataset.pkl'
    ...
    if os.path.exists(pkl_name):
        ...
        pair_pretrain, pretrain_max_len = read_langs('./data/pre-train/CamRest676/' + args['data_augmentation_file'],
                                                     tokenizer,
