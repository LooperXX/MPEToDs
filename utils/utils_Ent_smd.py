...
def prepare_data_seq(tokenizer, batch_size=100, data_augmentation_file=None):
    file_train = './data/fine-tune/SMD/train.txt'
    file_test = './data/fine-tune/SMD/test.txt'
    if data_augmentation_file is not None:
        file_dev = './data/pre-train/SMD/dev.txt'
        pkl_name = './data/pre-train/SMD/pretrain_dataset.pkl'
    else:
        file_dev = './data/fine-tune/SMD/dev.txt'
        pkl_name = './data/fine-tune/SMD/fine_tune_dataset.pkl'
    ...
    if os.path.exists(pkl_name):
        ...
        pair_pretrain, pretrain_max_len = read_langs('./data/pre-train/SMD/' + args['data_augmentation_file'],
                                                     tokenizer,
